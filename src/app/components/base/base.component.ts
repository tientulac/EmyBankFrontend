...
import { TestService } from 'src/app/utils/services/test.service';
import { AccountTypeService } from 'src/app/utils/services/account-type.service';
import { InterestRateService } from 'src/app/utils/services/interest-rate.service';
import { LoanService } from 'src/app/utils/services/loan.service';
import { AccService } from 'src/app/utils/services/acc.service';
import { TransactionService } from 'src/app/utils/services/transaction.service';
...
export class BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.Token = a.token;
    this.UserID_get = a.Info.user_id;
